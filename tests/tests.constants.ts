export const COLORS = [
    {
        ...
        rgbSpacesWithAlphaInPercentage: 'rgb(255 0 0 / 100%)',
        rgba: 'rgba(255,0,0,1)',
        rgbaSpaces: 'rgba(255 0 0 / 1)',
        rgbaSpacesInPercentage: 'rgba(255 0 0 / 100%)',
        ...
        hslSpacesWithAlphaInPercentage: 'hsl(0 100% 50% / 100%)',
        hsla: 'hsla(0,100%,50%,1)',
        hslaSpaces: 'hsla(0 100% 50% / 1)',
        hslaSpacesInPercentages: 'hsla(0 100% 50% / 100%)',
    ...
    },
    {
        ...
        rgbSpacesWithAlphaInPercentage: 'rgb(0 255 0 / 100%)',
        rgba: 'rgba(0,255,0,1)',
        rgbaSpaces: 'rgb(0 255 0 / 1)',
        rgbaSpacesInPercentage: 'rgb(0 255 0 / 100%)',
        ...
        hslSpacesWithAlphaInPercentage: 'hsl(120 100% 50% / 100%)',
        hsla: 'hsla(120,100%,50%,1)',
        hslaSpaces: 'hsla(120 100% 50% / 1)',
        hslaSpacesInPercentages: 'hsla(120 100% 50% / 100%)',
    ...
    },
    {
        ...
        rgbSpacesWithAlphaInPercentage: 'rgb(0 0 255 / 100%)',
        rgba: 'rgba(0,0,255,1)',
        rgbaSpaces: 'rgba(0 0 255 / 1)',
        rgbaSpacesInPercentage: 'rgba(0 0 255 / 100%)',
        ...
        hslSpacesWithAlphaInPercentage: 'hsl(240 100% 50% / 100%)',
        hsla: 'hsla(240,100%,50%,1)',
        hslaSpaces: 'hsla(240 100% 50% / 1)',
        hslaSpacesInPercentages: 'hsla(240 100% 50% / 100%)',
    ...
    },
    {
        ...
        rgbSpacesWithAlphaInPercentage: 'rgb(255 0 255 / 100%)',
        rgba: 'rgba(255,0,255,1)',
        rgbaSpaces: 'rgba(255 0 255 / 1)',
        rgbaSpacesInPercentage: 'rgba(255 0 255 / 100%)',
        ...
        hslSpacesWithAlphaInPercentage: 'hsl(300 100% 50% / 100%)',
        hsla: 'hsla(300,100%,50%,1)',
        hslaSpaces: 'hsla(300 100% 50% / 1)',
        hslaSpacesInPercentages: 'hsla(300 100% 50% / 100%)',
    ...
    },
    {
        ...
        rgbSpacesWithAlphaInPercentage: 'rgb(255 255 255 / 100%)',
        rgba: 'rgba(255,255,255,1)',
        rgbaSpaces: 'rgba(255 255 255 / 1)',
        rgbaSpacesInPercentage: 'rgba(255 255 255 / 100%)',
        ...
        hslSpacesWithAlphaInPercentage: 'hsl(0 0% 100% / 100%)',
        hsla: 'hsla(0,0%,100%,1)',
        hslaSpaces: 'hsla(0 0% 100% / 1)',
        hslaSpacesInPercentages: 'hsla(0 0% 100% / 100%)',
    ...
    },
    {
        ...
        rgbSpacesWithAlphaInPercentage: 'rgb(0 0 0 / 100%)',
        rgba: 'rgba(0,0,0,1)',
        rgbaSpaces: 'rgb(0 0 0 / 1)',
        rgbaSpacesInPercentage: 'rgb(0 0 0 / 100%)',
        ...
        hslSpacesWithAlphaInPercentage: 'hsl(0 0% 0% / 100%)',
        hsla: 'hsla(0,0%,0%,1)',
        hslaSpaces: 'hsla(0 0% 0% / 1)',
        hslaSpacesInPercentages: 'hsla(0 0% 0% / 100%)',
    ...
    },
    {
        ...
        rgbSpacesWithAlphaInPercentage: 'rgb(128 128 128 / 100%)',
        rgba: 'rgba(128,128,128,1)',
        rgbaSpaces: 'rgb(128 128 128 / 1)',
        rgbaSpacesInPercentage: 'rgb(128 128 128 / 100%)',
        ...
        hslSpacesWithAlphaInPercentage: 'hsl(0 0% 50% / 100%)',
        hsla: 'hsla(0,0%,50%,1)',
        hslaSpaces: 'hsla(0 0% 50% / 1)',
        hslaSpacesInPercentages: 'hsla(0 0% 50% / 100%)',
...
export const HEX3 = [
    ...
    },
    {
        ...
        rgbaPercent: 'rgba(100%,100%,100%,1)',
