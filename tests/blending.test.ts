...
describe('ColorTranslator blending tests', (): void => {
    it('Blending deep equals', (): void => {
        ...
        const blendFunctions = [
            {
                colorFn: ColorTranslator.toHEX,
                blendFn: ColorTranslator.getBlendHEX
            },
            {
                colorFn: ColorTranslator.toHEXA,
                blendFn: ColorTranslator.getBlendHEXA
            },
            {
                colorFn: ColorTranslator.toRGB,
                blendFn: ColorTranslator.getBlendRGB
            },
            {
                colorFn: ColorTranslator.toRGBA,
                blendFn: ColorTranslator.getBlendRGBA
            },
            {
                colorFn: ColorTranslator.toHSL,
                blendFn: ColorTranslator.getBlendHSL
            },
            {
                colorFn: ColorTranslator.toHSLA,
                blendFn: ColorTranslator.getBlendHSLA
            }
        ];
        ...
        // Check default steps
        expect(ColorTranslator.getBlendHEX(from, to)).toMatchObject(
