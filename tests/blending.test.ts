...
const hexBlendFunctions = [
    ...
    {
        colorFn: ColorTranslator.toHEXObject,
        blendFn: ColorTranslator.getBlendHEXObject
    },
    {
        colorFn: ColorTranslator.toHEXAObject,
        blendFn: ColorTranslator.getBlendHEXAObject
    }
];
...
const blendFunctions = [
    ...
    {
        colorFn: ColorTranslator.toRGBObject,
        blendFn: ColorTranslator.getBlendRGBObject
    },
    {
        colorFn: ColorTranslator.toRGBAObject,
        blendFn: ColorTranslator.getBlendRGBAObject
    },
    {
        colorFn: ColorTranslator.toHSLObject,
        blendFn: ColorTranslator.getBlendHSLObject
    },
    {
        colorFn: ColorTranslator.toHSLAObject,
        blendFn: ColorTranslator.getBlendHSLAObject
    }
];
...
describe('ColorTranslator blending tests', (): void => {
    it('Blending deep equals', (): void => {
        ...
        expect(ColorTranslator.getBlendHEX(from, to, -5)).toMatchObject(
            ColorTranslator.getBlendHEX(from, to, 5)
        );
    });
